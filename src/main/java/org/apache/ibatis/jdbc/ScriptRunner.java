...
public class ScriptRunner {
  ...
  private void executeFullScript(Reader reader) {
    ...
    try {
      ...
      throw new org.apache.ibatis.jdbc.RuntimeSqlException(message, e);
    }
  }
  ...
  private void setAutoCommit() {
    try {
      ...
      throw new org.apache.ibatis.jdbc.RuntimeSqlException("Could not set AutoCommit to " + autoCommit + ". Cause: " + t, t);
    }
  }
  ...
  private void commitConnection() {
    try {
      ...
      throw new org.apache.ibatis.jdbc.RuntimeSqlException("Could not commit transaction. Cause: " + t, t);
    }
  }
